...
public class team implements Comparable<team>{
	...
	public team matchup(team otherTeam, Map<team, String> superstar) {
		...
		this.SuperstarTakeover(otherTeam, superstar);
	...
	public int compareTo(team team1) {
		//Could probably be optimized with equal method?
		
		/*
		if(this.getName().equals(this.matchup(team1).getName())) {
			return 1;
		}
		if(team1.getName().equals(this.matchup(team1).getName())) {
			return -1;
		}
		*/
	...
	public Map<Integer, team> AssignSeed(List<team> input){
